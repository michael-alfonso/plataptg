...
<body <?php body_class(); ?>>
      <div class="header">
        ...
        <div class="logo"><?php photolite_the_custom_logo(); ?>
        <!---<a href="<?php echo esc_url( home_url( '/' ) ); ?>" >
          <img src="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/uploads/2016/07/cropped-logo-shop-for-fun.jpg">
        </a>-->
         ...
         <?php if(get_theme_mod('page-setting'.$f) != '') { ?>
          <?php $page_query = new WP_Query('page_id='.get_theme_mod('page-setting'.$f)); ?>
            <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
              ...
              ?>
              <div class="img">
<img src="<?php if(get_field('imagen')) { echo the_field('imagen'); } else { echo esc_url(get_template_directory_uri().'/images/no-image.jpg'); } ?>">
              </div>
                      <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>        
                                <p><?php //the_excerpt(); ?><?php the_field('description'); ?></p>        
