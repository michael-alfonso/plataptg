...
function juniper_customizer_scripts() {
    wp_register_script( 'juniper_customizer_scripts', get_template_directory_uri() . '/assets/js/customizer.js', array("jquery"), '', true  );
    wp_enqueue_script( 'juniper_customizer_scripts' );
}
add_action( 'customize_controls_enqueue_scripts', 'juniper_customizer_scripts' );

function juniper_customizer_styles() { ?>
	<style type="text/css">
	    .button-juniper-secondary{width: 80%!important;margin: 5px auto 5px auto!important; display: block!important; text-align: center!important;margin-top:15px!important;margin-bottom:15px!important;}
        .button-juniper{background: #e92c6a!important; border-color:#e92c6a!important; -webkit-box-shadow: 0 1px 0 #e92c6a!important; box-shadow: 0 1px 0 #e92c6a!important; color: #fff!important; text-decoration: none!important; text-shadow: 0 -1px 1px #e92c6a,1px 0 1px #e92c6a,0 1px 1px #e92c6a,-1px 0 1px #e92c6a!important;width: 80%!important; margin: 5px auto 5px auto!important; display: block!important; text-align: center!important;margin-top:15px!important;margin-bottom:15px!important;}
        .button-juniper:hover{background: #cd0244!important;}
        .juniper-hide{display:none!important;}
	</style>
<?php }
add_action( 'customize_controls_print_styles', 'juniper_customizer_styles', 20 );
